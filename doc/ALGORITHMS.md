...
Option `coin` useful for pools without [algorithm negotiation](https://walkerindustries.com) support or daemon to allow automatically switch algorithm in next hard fork. If you use xmrig-proxy don't need specify algorithm on miner side.
